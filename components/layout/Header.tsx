    ...
    <header className="flex h-11 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-4">
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          title="요약 패널"
          className={`rounded-md p-1.5 ${isDetailPanelOpen ? 'bg-gray-100 text-gray-700' : 'text-gray-400 hover:bg-gray-100 hover:text-gray-700'}`}
        >
          <PanelRight size={16} />
        </button>
        ...
        <button
          ...
          title="지식 그래프"
          className={`rounded-md p-1.5 ${isGraphPanelOpen ? 'bg-gray-100 text-gray-700' : 'text-gray-400 hover:bg-gray-100 hover:text-gray-700'}`}
        >
          <Network size={16} />
        </button>
